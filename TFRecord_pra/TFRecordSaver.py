...
#%%
tfrecord_filename_test='flowers' #None
dataset_dir_test='F:\\OneDrive\\Research\\180506TFRecord\\Datasets\\flowers\\'
#python create_tfrecord.py  --tfrecord_filenamE=flowers --dataset_dir=flowers/

#====================================================DEFINE YOUR ARGUMENTS=======================================================================
flags = tf.app.flags
#State your dataset directory
flags.DEFINE_string('dataset_dir', tfrecord_filename_test, 'String: Your dataset directory')
...
flags.DEFINE_integer('num_shards', 5, 'Int: Number of shards to split the TFRecord files')

# Seed for repeatability.
flags.DEFINE_integer('random_seed', 0, 'Int: Random seed to use for repeatability.')

#Output filename for the naming the TFRecord file
flags.DEFINE_string('tfrecord_filename', dataset_dir_test, 'String: The output filename to name your TFRecord file')
